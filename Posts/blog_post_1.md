...
- Is currently hacking on [LBEAST](https://github.com/ajcampbell1333), an open-source framework to turn dead shopping malls into location-based VR theme parks with almost zero new hardware.
