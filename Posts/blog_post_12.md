...
<div style="display: flex; flex-wrap: wrap; gap: 5px; margin: 10px 0;">
  <img src="Images/eye-tracking-paper-video-01.png" alt="Eyes on Many paper — mode-switching gestures" style="flex: 1; min-width: 150px; height: auto; object-fit: contain;" />
  <img src="Images/eye-tracking-paper-video-02.png" alt="Eyes on Many paper — gaze and pinch subselection" style="flex: 1; min-width: 150px; height: auto; object-fit: contain;" />
</div>
