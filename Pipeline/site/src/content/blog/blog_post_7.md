...
I call it **the orange slice**: thick near your face, tapering to a curved rind at the far horizon.
...
How do you give the user instant, uniform hover-and-select over **EVERY** single one of those voxels the same effortless way the mouse does over pixels?
...
Raycasting gives you a high-fidelity illusion of reach for maybe 3–5 extra feet beyond arm's length. Beyond that, interactive fidelity collapses exponentially because it's perspective-based.

A 2° wrist twitch moves an object 4 inches when it's 2 m away.

The same 2° twitch moves it 10 feet when the object is 50 m away.
